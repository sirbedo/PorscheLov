...
<head>
    ...
    <script>
        // JavaScript Script 1: Alert Welcome Message
        window.onload = () => {
            alert("Welcome to Porsche Lovers! Enjoy your visit.");
        };

        // JavaScript Script 2: Form Validation
        ...
        // JavaScript Script 3: Dynamic Clock
...
<body>
    ...
    <main>
        ...
        <!-- PHP Script 3: Horsepower to Kilowatts Converter -->
        <section>
